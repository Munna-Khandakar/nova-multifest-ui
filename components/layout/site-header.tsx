...
export function SiteHeader() {
    return (
        <header id="site-header"
                className="bg-background/95 supports-backdrop-filter:backdrop-blur sticky top-0 z-40 border-b">
            ...
            <Container className="flex h-16 items-center justify-between gap-4">
                ...
                >
          <span
              className="bg-primary/10 text-primary inline-flex size-9 items-center justify-center rounded-lg text-sm font-semibold">
            NM
          </span>
